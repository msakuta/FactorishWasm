...
pub(crate) struct Assets {
    ...
    pub tex_ore_mine_exit: WebGlTexture,
    pub tex_furnace: WebGlTexture,
    pub tex_electric_furnace: WebGlTexture,
    pub tex_assembler: WebGlTexture,
    pub tex_lab: WebGlTexture,
    pub tex_boiler: WebGlTexture,
    pub tex_boiler_center: WebGlTexture,
    pub tex_boiler_connector: WebGlTexture,
    ...
    pub tex_direction_white: WebGlTexture,
    pub tex_sparse_direction: WebGlTexture,
    pub tex_flow_direction: WebGlTexture,
...
impl Assets {
    pub fn new(context: &GL, image_assets: js_sys::Array) -> Result<Self, JsValue> {
        ...
        Ok(Assets {
            ...
            tex_ore_mine_exit: load_texture_local("mineExit")?,
            tex_furnace: load_texture_local("furnace")?,
            tex_electric_furnace: load_texture_local("electricFurnace")?,
            tex_assembler: load_texture_local("assembler")?,
            tex_lab: load_texture_local("lab")?,
            tex_boiler: load_texture_local("boiler")?,
            tex_boiler_center: load_texture_local("boilerCenter")?,
            tex_boiler_connector: load_texture_local("boilerConnector")?,
            ...
            tex_direction_white: load_texture_local("directionWhite")?,
            tex_sparse_direction: load_texture_local("sparseDirection")?,
            tex_flow_direction: load_texture_local("flowDirection")?,
